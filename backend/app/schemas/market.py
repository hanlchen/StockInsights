...
class DailyRecommendationResponse(BaseModel):
    ...
    market_cap: float | None = None
    disclaimer: str = (
        "Generated by an AI model reasoning over already-computed momentum "
        "metrics for informational/educational purposes only. This is not "
        "financial advice and is not a recommendation to buy or sell any "
